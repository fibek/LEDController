...
def menu(event):
    if modes.get() == 'Static color':
        ...
        Label(frame1, text='\nSet static color', font=('none', 14), bg="#181b28", fg="#d3dae3") .grid(row=0, column=2)
        Label(frame1, text='R: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=1, column=2, sticky=S)
        entryr = Entry(frame1, width=4, bg='white', fg='black', borderwidth=0) 
        entryr.grid(row=1, column=2, sticky=E)
        Label(frame1, text='G: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=2, column=2, sticky=S)
        entryg = Entry(frame1, width=4, bg='white', fg='black', borderwidth=0) 
        entryg.grid(row=2, column=2, sticky=E)
        Label(frame1, text='B: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=3, column=2, sticky=S)
        entryb = Entry(frame1, width=4, bg='white', fg='black', borderwidth=0) 
        entryb.grid(row=3, column=2, sticky=E)
        Label(frame1, text='\n', font=('none', 3), bg="#181b28"). grid(row=4)
        Button(frame1, text='Set', fg='white', width=4, font=('none', 13), bg="#181b28", borderwidth=1, command=lambda: statclr(entryr.get(), entryg.get(), entryb.get())) .grid(row=5, column=2, sticky=S)
        ...
        #frame2 = Frame(root)
        print(modes.current(), modes.get())
        Label(frame2, text='\nRainbow', font=('none', 14), fg="#d3dae3", bg="#181b28") .grid(row=0, column=2, sticky=W)
        Label(frame2, text='Unlimited: time = 0', font=('none', 10), bg="#181b28", fg="#d3dae3") .grid(row=1, column=2, sticky=W) 
        Label(frame2, text='Time (s): ', font=('none', 12), fg="#d3dae3", bg="#181b28") .grid(row=20, column=2, sticky=S)
        ...
        Button(frame2, text='Set', fg='white', width=4, font=('none', 13), bg="#181b28", borderwidth=1, command=lambda: rainbow(entrytime.get())) .grid(row=22, column=2, sticky=S)
        Button(frame2, text='Stop', fg='white', width=4, font=('none', 13), bg="#181b28", borderwidth=1,  command=lambda: r_interrupt()) .grid(row=22, column=3, sticky=W)
        ...
        try:
            ...
            print('Nie znam pani frame1, ani frame2')   #...and this
        print(modes.current(), modes.get())
        Label(frame3, text='\nSet 1st color:', font=('none', 14), bg="#181b28", fg="#d3dae3") .grid(row=0, column=1)
        Label(frame3, text='R: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=1, column=1, sticky=S)
        entryr1 = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0) 
        entryr1.grid(row=1, column=1, sticky=E)
        Label(frame3, text='G: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=2, column=1, sticky=S)
        entryg1 = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0) 
        entryg1.grid(row=2, column=1, sticky=E)
        Label(frame3, text='B: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=3, column=1, sticky=S)
        entryb1 = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0) 
        entryb1.grid(row=3, column=1, sticky=E)
        Label(frame3, text='\n', font=('none', 3), bg="#181b28"). grid(row=4)
        Label(frame3, text='\n   Set 2nd color:', font=('none', 14), bg="#181b28", fg="#d3dae3") .grid(row=0, column=2)
        Label(frame3, text='R: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=1, column=2, sticky=S)
        entryr2 = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0) 
        entryr2.grid(row=1, column=2, sticky=E)
        Label(frame3, text='G: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=2, column=2, sticky=S)
        entryg2 = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0) 
        entryg2.grid(row=2, column=2, sticky=E)
        Label(frame3, text='B: ', font=('none', 12), bg="#181b28", fg="#d3dae3") .grid(row=3, column=2, sticky=S)
        entryb2 = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0) 
        entryb2.grid(row=3, column=2, sticky=E)
        Label(frame3, text='\n', font=('none', 3), bg="#181b28"). grid(row=4)
        Label(frame3, text='Choose 1st range\n of LEDs:', font=('none', 10), bg="#181b28", fg="#d3dae3") .grid(row=5, column=1)
        Label(frame3, text='Choose 2nd range\n of LEDs:', font=('none', 10), bg="#181b28", fg="#d3dae3") .grid(row=5, column=2)
        entryrng1f = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0)
        entryrng1f.grid(row=6,column=1, sticky=W)
        Label(frame3, text='-', font=('none', 15), bg="#181b28", fg="#d3dae3") .grid(row=6, column=1, sticky=S)
        ...
        Label(frame3, text='-', font=('none', 15), bg="#181b28", fg="#d3dae3") .grid(row=6, column=2, sticky=S)
        entryrng2t = Entry(frame3, width=4, bg='white', fg='black', borderwidth=0)
        entryrng2t.grid(row=6, column=2, sticky=E)
        Button(frame3, text='Set', fg='white', width=4, font=('none', 13), bg="#181b28", borderwidth=1, command=lambda: dblstatclr(entryr1.get(), entryg1.get(), entryb1.get(), entryr2.get(), entryg2.get(), entryb2.get(), entryrng1f.get(), entryrng1t.get(), entryrng2f.get(), entryrng2t.get())) .grid(row=7, column=1, sticky=E)
